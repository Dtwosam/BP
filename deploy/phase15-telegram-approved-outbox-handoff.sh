...
for required in   BP_TELEGRAM_PROJECT_STATE_FILE   BP_TELEGRAM_ORIGIN_KEY_FILE   BP_TELEGRAM_ORIGIN_KEY_ID   BP_TELEGRAM_TRANSPORT_KEY_FILE   BP_TELEGRAM_TRANSPORT_KEY_ID   BP_APPROVED_INTENT_ID   BP_APPROVED_REQUEST_SHA256
do
