...
def test_v3_live_gate_reassessment_source_truth_stays_fail_closed() -> None:
    ...
    assert gate["model_sha256"] == "124627e15cab3997b8abe54ec5237450d976ab5682953f45a1399a76b6dae0e7"
    ...
    spec = (ROOT / "docs/superpowers/specs/2026-09-23-phase-14-v3-live-gate-reassessment.md").read_text(encoding="utf-8")
