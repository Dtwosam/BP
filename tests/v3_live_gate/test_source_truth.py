...
def test_v3_live_gate_reassessment_source_truth_stays_fail_closed() -> None:
    ...
    assert master["sufficiently_large_live_paper_sample_with_uncertainty"] == (
        "insufficient_evidence"
    )
    assert master["calibration_acceptable"] == "insufficient_evidence"
    assert master["walk_forward_results_stable_enough"] == "insufficient_evidence"
