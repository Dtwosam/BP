...
def test_phase15_ten_dollar_canary_source_truth_is_narrow_and_not_activated() -> None:
    ...
    assert contract["version"] == "phase15-v3-ten-dollar-canary-v1"
    assert contract["max_live_order_intents"] == 1
    assert contract["max_trade_size_usd"] == "10.00"
    assert contract["max_total_exposure_usd"] == "10.00"
    assert contract["max_daily_loss_usd"] == "10.00"
    assert contract["max_consecutive_losses"] == 1
