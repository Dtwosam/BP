...
def test_project_state_locks_gate_b_engineering_boundary() -> None:
    ...
    assert checkpoint["v2_gate_b_readiness_status"] == (
        "PRODUCTION_PASS_READY_TRUE_GATE_B_ATTEMPT_CONSUMED"
    )
