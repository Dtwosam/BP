...
The next permitted work is continued frozen-V3 paper observation and V4 prospective collection. Do not rerun the one-shot V3 reassessment without a separately versioned reason, and do not bypass geographic restrictions. Phase 15 controlled live launch remains blocked.
