...
**Implementation status:** COMPLETE and merged. PR #50 merged to `main` as `89b00ba8df4acdfad075cb31df596c86dc148f08`; post-merge CI `33875494229` passed 903 tests plus Ruff, deployment/health/dashboard validation. The engineering plan is closed; the production partition migration remains unperformed and separately gated. Follow-up read-only host preflight hardening is tracked independently on `phase14-storage-preflight`.
...
- [x] **Step 1: Write failing PostgreSQL tests for fresh initialization**
...
- [x] **Step 3: Implement minimal PostgreSQL DDL helpers**
...
- [x] **Step 5: Add migration parity test**
...
- [x] **Step 6: Run focused PostgreSQL suite GREEN and commit**
...
- [x] **Step 5: Run recorder + partition tests GREEN**
...
- [x] **Step 4: Implement retirement path**
...
- [x] **Step 5: Run legacy archive tests plus partition suite GREEN**
...
- [x] **Step 1: RED tests for maintenance freshness**
...
- [x] **Step 2: RED tests for retention lag and writable partition**
...
- [x] **Step 3: RED tests for health filesystem selection**
  - `storage_health_path` overrides archive path.
  - When unset, archive path remains fallback.

- [x] **Step 4: Implement durable run recording**
...
- [x] **Step 6: Run storage suites GREEN**
...
- [x] **Step 1: RED deployment-asset tests**
...
- [x] **Step 2: Implement startup provisioning**
...
- [x] **Step 3: Update index installer**
...
- [x] **Step 4: Run deploy tests and shell/Python validation**
...
- [x] **Step 1: RED static rollout safety tests**
...
- [x] **Step 2: Implement detached/idempotent migration helper**
...
- [x] **Step 3: Add CI syntax validation**
  - `bash -n scripts/deploy/phase14_partitioned_storage_rollout_cloudshell.sh`.

- [x] **Step 4: Run rollout static tests GREEN and commit**
...
- [x] **Step 6: Keep PR draft until all exact-head gates are green**
