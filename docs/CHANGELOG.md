...
- Opened Phase 15 only for `phase15-v3-ten-dollar-canary-v1`: one live submission intent maximum, $10 maximum fee-inclusive total cost, $10 maximum total exposure, $10 maximum daily loss, one consecutive loss, unchanged frozen V3 model/timing/calibration, and `min_edge=0.075`.
