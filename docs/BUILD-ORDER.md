...
1. Resume frozen V3 paper observation and V4 prospective collection under the existing research-only prospective boundaries. Use the read-only combined observation report for ongoing evidence.
