...
**Keep `bp-recorder.service` stopped and do not run Gate B. PR #162 merged the dedicated fail-closed recovery gate to `main` as `63a0eb8b52f736db4b3e329adcdec06ae2ae02f9`; exact PR head `8416ac4242382284f1d7312b445df64465a26135` passed CI `34388036133` with 1,028 tests plus Historical Backfill Smoke `34388035993`, Live Recorder Smoke `34388035795`, and Recorder Short Soak `34388035889`, and post-merge main CI `34388363196` passed 1,028 tests. The exact minimal production candidate remains `e9c7afc1536880e4612cb6e3d1a7282fa37c69f5`; verification-only PR #161 was closed without merge after green CI. Engineering readiness does not authorize production: checkout mutation and recorder start require separate explicit approval. Any future authorized PASS must prove a real maintenance cycle succeeds under active four-worker recorder load, all four feeds remain healthy with zero backpressure, storage remains `ok`, timers are restored, and no holdout artifact is read or created. Only after that recovery may the repeatable feature-only Gate B readiness helper resume; `READY=true` remains a prerequisite only and the final holdout stays untouched.**
