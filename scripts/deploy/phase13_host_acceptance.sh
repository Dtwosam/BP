...
run_candidate() {
  sudo -u bp env \
    ...
    PHASE13_ACCEPTED_PHASE9_5M_RUN_ID="$ACCEPTED_PHASE9_5M_RUN_ID" \
    PHASE13_ACCEPTED_PHASE9_5M_SHA="$ACCEPTED_PHASE9_5M_SHA" \
    PHASE13_ACCEPTED_PHASE8_5M_RUN_ID="$ACCEPTED_PHASE8_5M_RUN_ID" \
    PHASE13_ACCEPTED_PHASE8_5M_SHA="$ACCEPTED_PHASE8_5M_SHA" \
    PHASE13_ACCEPTED_PHASE7_5M_RUN_ID="$ACCEPTED_PHASE7_5M_RUN_ID" \
    PHASE13_ACCEPTED_PHASE7_5M_SHA="$ACCEPTED_PHASE7_5M_SHA" \
    "$@"
}
